...
def update(cellmap):
    ...
    if rangePreferedArea:
        ...
        cellmap.face_df["prefered_area"] = 20
    ...
    if rangeLengthElasticity:
        lower_FRC_length_elasticity = 400
        higher_FRC_length_elasticity = 600
        lower_ECM_length_elasticity = 200
        higher_ECM_length_elasticity = 300
        ...
        cellmap.edge_df["length_elasticity"] = 600
        cellmap.edge_df["length_elasticity_ECM"] = 300
        cellmap.edge_df["length_elasticity_FRC"] = 300
